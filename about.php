...
// Sample dynamic data
$teamMembers = [
    ['name' => 'Tejas thakare', 'role' => 'Fornt end'],
    ['name' => 'niraj joshi', 'role' => 'Back end'],
    ['name' => 'smitesh wagh', 'role' => 'Data base'],
...
<body>
  <header>
    <h1>About Us</h1>
    <ul><li><a class="active" href="home1.html">
        Home</a></li>
...
<br><br>
  <main>
    ...
    <h2>Creating by college student</h2>
    <?php
    ...
    <h2>Contact Us</h2>
    <p>Email: tthakare67@gmial.com<br>Phone: (123) 456-7890</p>
  </main>
